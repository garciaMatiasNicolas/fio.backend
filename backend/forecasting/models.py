...
class MetricsScenarios(models.Model):
    ...
    model = models.CharField(max_length=200)
    ytg = models.IntegerField(null=True, blank=True, default=0)
    qtg = models.IntegerField(null=True, blank=True, default=0)
    mtg = models.IntegerField(null=True, blank=True, default=0)
    updated_at = models.DateTimeField(auto_now_add=False, blank=True, null=True)